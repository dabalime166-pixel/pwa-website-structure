...
export const i18n = {
  en: {
    ...
    filterAll: 'All',
    heroTitle: 'Private demo lounge',
    heroSub: 'Crash, slots and mines — open instantly. No signup, no deposit.',
  },
  ru: {
    ...
    filterAll: 'Все',
    heroTitle: 'Приватный демо-зал',
    heroSub: 'Краш, слоты и mines — сразу в браузере. Без регистрации и депозита.',
  },
} as const
