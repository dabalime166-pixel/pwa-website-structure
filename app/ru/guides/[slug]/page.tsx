...
const SEO: Record<string, { title: string; description: string; keywords: string }> = {
  plinko: {
    title: 'Стратегия Плинко 2026 — Как выиграть в Plinko онлайн | 1weapp',
    description:
  ...
  mines: {
    title: 'Стратегия Mines 2026 — Лучшие тактики для игры в Мины | 1weapp',
    description:
  ...
  crash: {
    title: 'Стратегия Краш-игр 2026 — Когда выводить и как выиграть | 1weapp',
    description:
  ...
  mistakes: {
    title: 'Топ-7 ошибок игроков в 2026 году — Гайд iGaming | 1weapp',
    description:
  ...
  rtp: {
    title: 'Гайд по RTP и волатильности 2026 — Что это значит и как использовать | 1weapp',
    description:
  ...
  bonuses: {
    title: 'Гайд по бонусам казино 2026 — Как получать и отыгрывать бонусы | 1weapp',
    description:
      'Всё о бонусах казино: приветственные бонусы, фриспины, вейджер, кэшбэк и как выбирать самые выгодные предложения.',
    keywords:
      'гайд бонусы казино, вейджер бонус, фриспины гайд, приветственный бонус казино, как отыграть вейджер, лучшие бонусы казино 2026',
  },
  responsible: {
    title: 'Ответственная игра 2026 — Управление банкроллом и безопасная игра | 1weapp',
    description:
  ...
  myths: {
    title: 'Мифы об онлайн-слотах 2026 — Факты vs Вымысел в казино | 1weapp',
    description:
