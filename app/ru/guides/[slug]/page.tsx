...
/* ─── SEO-оптимизированные title и description для каждого гайда (RU) ─── */
const SEO: Record<string, { title: string; description: string; keywords: string }> = {
  plinko: {
    title: 'Стратегия Плинко 2025 — Как выиграть в Plinko онлайн | CrashGames',
    description:
  ...
  mines: {
    title: 'Стратегия Mines 2025 — Лучшие тактики для игры в Мины | CrashGames',
    description:
  ...
  crash: {
    title: 'Стратегия Краш-игр 2025 — Когда выводить и как выиграть | CrashGames',
    description:
  ...
  mistakes: {
    title: 'Топ-7 ошибок игроков в 2025 году — Гайд iGaming | CrashGames',
    description:
  ...
  rtp: {
    title: 'Гайд по RTP и волатильности 2025 — Что это значит и как использовать | CrashGames',
    description:
  ...
  bonuses: {
    title: 'Гайд по бонусам казино 2025 — Как получать и отыгрывать бонусы | CrashGames',
    description:
  ...
  responsible: {
    title: 'Ответственная игра 2025 — Управление банкроллом и безопасная игра | CrashGames',
    description:
  ...
  myths: {
    title: 'Мифы об онлайн-слотах 2025 — Факты vs Вымысел в казино | CrashGames',
    description:
...
export async function generateMetadata({
  ...
  const seo = SEO[slug] ?? {
    title: `${guide.titleRu} — Гайд iGaming | CrashGames`,
    description: guide.subtitleRu,
    keywords: guide.tagRu,
  }
