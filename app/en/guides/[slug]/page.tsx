...
const SEO: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  mines: {
    title: 'Mines Game Strategy Guide 2025 — Best Tactics & How to Win | CrashGames',
    description:
  ...
  crash: {
    title: 'Crash Game Strategy Guide 2025 — When to Cash Out & How to Win | CrashGames',
    description:
  ...
  mistakes: {
    title: 'Top 7 Gambling Mistakes to Avoid in 2025 — iGaming Player Guide | CrashGames',
    description:
  ...
  rtp: {
    title: 'RTP & Volatility Guide 2025 — What They Mean and How to Use Them | CrashGames',
    description:
  ...
  bonuses: {
    title: 'Casino Bonus Guide 2025 — How to Claim & Clear Bonuses the Right Way | CrashGames',
    description:
  ...
  responsible: {
    title: 'Responsible Gambling Guide 2025 — Bankroll Management & Safe Play | CrashGames',
    description:
  ...
  myths: {
    title: 'Online Slot Myths Debunked 2025 — Casino Facts vs Fiction | CrashGames',
    description:
...
export default async function Page({
  ...
  const guide = GUIDES.find((g) => g.id === slug)
  if (!guide) notFound()
  return <GuideSinglePage slug={slug} lang="en" />
}
